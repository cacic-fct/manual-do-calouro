...
import People from "../../src/components/scholarships/People.tsx";
...
Foi por meio dessas lutas que, hoje, o nosso câmpus tem um restaurante universitário de qualidade,
...
- Preencher o formulário de inscrição, indicando para qual auxílio deseja se inscrever,
...
- Abra uma conta corrente individual no Banco do Brasil. Os depósitos serão feitos apenas por meio deste banco, nesta modalidade de conta.

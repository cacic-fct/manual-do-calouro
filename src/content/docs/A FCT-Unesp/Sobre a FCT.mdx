...
import Timeline from '/src/components/fct/Timeline.astro';
...
desde os primórdios da FCL Presidente Prudente, passando por todas as suas mudanças ao longo das décadas.
